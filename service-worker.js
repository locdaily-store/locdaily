// Build: 27.9.0-v28.15.3 Global Interaction Latency Hotfix
"use strict";

const APP_VERSION = "27.9.0-v28.15.3";
const CACHE_PREFIX = "ldm-";
const SHELL_CACHE = `${CACHE_PREFIX}release27-9-0-github-origin-v28-15-3`;
const RUNTIME_CACHE = `${CACHE_PREFIX}release27-9-0-github-origin-runtime-v28-15-3`;
...
const APP_SHELL = [
    ...
    "./assets/icons/maskable-512.png", "./locdailymar-logo.png", "./style.css", "./css/global-responsive-navigation.css", "./css/system-dashboard-ui.css", "./css/developer-navigation.css", "./css/privacy-center.css", "./css/peripheral-setup-embedded.css", "./css/help-center.css", "./css/support-center-v21.css", "./css/multi-store-dashboard-theme.css", "./css/central-catalog-control.css", "./setting.js", "./employee-id.js",
    "./js/app-version.js", "./js/pwa-manager.js", "./js/ui-copy-cleanup-v2861.js?v=27.9.0-v28.15.3-perf", "./js/demo-account-runtime.js?v=27.9.0-v28.10.1", "./css/demo-production-complete-v28101.css?v=27.9.0-v28.10.1", "./js/system-theme-sync-v2824.js?v=27.9.0-v28.9.2", "./js/customer-safe-copy-v2828.js?v=27.9.0-v28.15.3-perf", "./js/public-contact-config-v2835.js", "./js/homepage-feedback-contact-v2835.js", "./js/customer-refund-v2825.js", "./js/local-time.js", "./js/developer-navigation.js", "./js/developer-contact-settings-v2835.js", "./js/peripheral-setup.js", "./js/peripheral-setup-embedded.js", "./js/receipt-customizer-embedded.js", "./js/onboarding-service.js", "./js/onboarding-wizard.js", "./js/onboarding-dashboard.js", "./js/error-monitor.js", "./js/error-monitor-admin.js", "./js/support-center.js", "./js/privacy-center.js", "./js/license-quota-sync-v2841.js", "./js/user-guide.js", "./js/storage-engine.js", "./js/storage-quota-guard.js", "./js/storage-health-monitor.js", "./js/security-hardening.js", "./js/qa-runtime.js", "./js/recovery-service.js", "./js/global-system-navigation.js", "./js/primary-owner-service.js", "./js/central-catalog-control.js",
    ...
    "./js/transactions-service.js", "./js/reporting-service.js", "./js/dashboard-report-source.js", "./js/attendance-workforce-service.js", "./js/attendance-workforce-ui.js", "./js/master-shift-ui.js", "./js/ketidakhadiran-ui.js", "./js/attendance-service.js",
    "./js/attendance-bootstrap.js", "./css/attendance-workforce.css", "./css/workforce-dashboard-pages.css", SUPABASE_CDN
];
...
async function networkFirstAsset(request){
    try{
        ...
        return (await caches.match(request,{ignoreSearch:true})) || new Response("Resource aplikasi belum tersedia.",{status:503});
    }
}
...
self.addEventListener("fetch", event => {
    ...
    // Kode aplikasi harus network-first agar deployment GitHub Pages baru
    // tidak tertahan oleh asset lama yang masih berada di cache browser.
    if(
    ...
    // Gambar/font statis boleh cache-first.
