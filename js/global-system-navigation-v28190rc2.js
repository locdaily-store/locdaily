(function(){
    ...
    const NAV_VERSION="27.9.0-v28.19.1-final";
     ...
     */
    const ROUTES=[
        {page:"dashboard.html",icon:"📊",label:"Dashboard",group:"Utama",roles:["owner","admin","kasir"],feature:"dashboard",permission:"dashboard.view",quick:true},
        {page:"absensi.html",icon:"📝",label:"Absensi",group:"Utama",roles:["owner","admin","kasir"],feature:"attendance",permission:"attendance.use"},
        {page:"master-shift.html",icon:"🗓️",label:"Master Shift",group:"Utama",roles:["owner"],feature:"attendance",permission:"master_shift.manage"},
        {page:"ketidakhadiran.html",icon:"📋",label:"Ketidakhadiran",group:"Utama",roles:["owner","admin","kasir"],feature:"attendance",permission:"absence.view"},
        {page:"kasir.html",icon:"💵",label:"Kasir",group:"Utama",roles:["owner","admin","kasir"],feature:"pos",permission:"pos.use",quick:true},
        {page:"barang.html",icon:"📦",label:"Barang",group:"Inventori",roles:["owner","admin","kasir"],feature:"inventory",permission:"inventory.view",badge:"navBadge"},
        {page:"kartu-stok.html",icon:"📒",label:"Kartu Stok",group:"Inventori",roles:["owner","admin","kasir"],feature:"stock_card",permission:"stock_card.view"},
        {page:"stock-opname.html",icon:"📋",label:"Stock Opname",group:"Inventori",roles:["owner","admin","kasir"],feature:"stock_opname",permission:"stock_opname.use"},
        {page:"multi-store.html",icon:"⇄",label:"Multi-Toko & Transfer",group:"Inventori",roles:["owner","admin"],feature:"multi_store",permission:"multi_store.use",quick:true},
        {page:"supplier.html",icon:"🏢",label:"Supplier",group:"Supplier & Pembelian",roles:["owner","admin"],feature:"suppliers",permission:"suppliers.use"},
        {page:"Purchase-Order.html",icon:"🛒",label:"Purchase Order",group:"Supplier & Pembelian",roles:["owner","admin"],feature:"purchase_order",permission:"purchase_order.use",badge:"pendingPOBadge"},
        {page:"goods.receipt.html",icon:"📥",label:"Goods Receipt",group:"Supplier & Pembelian",roles:["owner","admin"],feature:"goods_receipt",permission:"goods_receipt.use",badge:"pendingGRBadge"},
        {page:"retur.html",icon:"↩️",label:"Retur",group:"Keuangan & Laporan",roles:["owner","admin","kasir"],feature:"returns",permission:"returns.use"},
        {page:"laporan.html",icon:"📑",label:"Laporan",group:"Keuangan & Laporan",roles:["owner","admin","kasir"],feature:"reports",permission:"reports.view",quick:true},
        {page:"owner-control-center.html",icon:"🏛️",label:"Kontrol Pusat",group:"Keuangan & Laporan",roles:["owner"],feature:"central_control",permission:"central_control.view",primaryOwnerOnly:true},
        {page:"pengeluaran.html",icon:"💸",label:"Pengeluaran",group:"Keuangan & Laporan",roles:["owner","admin"],feature:"expenses",permission:"expenses.manage"},
        {page:"shift-closing.html",icon:"🔒",label:"Closing Shift",group:"Closing & Data",roles:["owner","admin"],feature:"shift_closing",permission:"shift_closing.use"},
        {page:"eod.html",icon:"🌙",label:"End of Day",group:"Closing & Data",roles:["owner","admin"],feature:"eod",permission:"eod.use",requiresEodReady:true},
        {page:"backup%20%26%20restore.html",icon:"💾",label:"Backup & Restore",group:"Closing & Data",roles:["owner","admin"],feature:"backup_restore",permission:"backup_restore.use"},
        {page:"jabatan-hak-akses.html",icon:"🪪",label:"Jabatan & Hak Akses",group:"Sistem",roles:["owner"],feature:"central_control",permission:"job_roles.manage",primaryOwnerOnly:true},
        {page:"account-management.html",icon:"👥",label:"Management Akun",group:"Sistem",roles:["owner"],feature:"cloud_accounts",permission:"accounts.manage"},
        {page:"device-management.html",icon:"💻",label:"Perangkat Toko",group:"Sistem",roles:["owner"],feature:"cloud_devices",permission:"devices.manage"},
        {page:"pwa-settings.html",icon:"📲",label:"Aplikasi & Update",group:"Sistem",roles:["owner","admin","kasir"],feature:"app_update",permission:"app_update.use"},
        {page:"penyimpanan.html",icon:"🗄️",label:"Penyimpanan & Retensi",group:"Sistem",roles:["owner","admin"],feature:"app_update",permission:"storage.manage"},
        {page:"recovery-center.html",icon:"🛟",label:"Pemulihan & Sinkronisasi",group:"Sistem",roles:["owner","admin","kasir"],feature:"recovery_center",permission:"recovery.use"},
        {page:"qa-security-performance.html",icon:"🧪",label:"Pemeriksaan Sistem & Keamanan",group:"Sistem",roles:["owner"],feature:"qa_security",permission:"qa_security.view"},
        {page:"setup-awal.html",icon:"🚀",label:"Setup Awal",group:"Sistem",roles:["owner"],infrastructure:true},
        {page:"support-center.html",icon:"🛟",label:"Pusat Bantuan & Support",group:"Sistem",roles:["owner","admin","kasir"],permission:"support.use"},
        {page:"privacy-center.html",icon:"🔐",label:"Privasi & Data",group:"Sistem",roles:["owner","admin","kasir"],permission:"privacy.view",infrastructure:true},
        {page:"license.html",icon:"🔑",label:"Lisensi & Paket",group:"Sistem",roles:["owner","admin","kasir"],permission:"license.view"},
        {page:"panduan.html",icon:"📘",label:"Panduan Pengguna",group:"Sistem",roles:["owner","admin","kasir"],permission:"support.use"}
    ];
    ...
    function routeAllowed(route,role,eodReady){
        ...
        if(route.permission&&window.LDMEmployeePermissions&&typeof window.LDMEmployeePermissions.can==="function"&&!window.LDMEmployeePermissions.can(route.permission))return false;
    ...
    function refreshContext(){
        ...
        const job=window.LDMEmployeePermissions?.current?.()?.job_role_name||"";
        document.querySelectorAll(".ldm-global-role").forEach(node=>{node.textContent=`👤 ${job||role}`});
    }
    ...
    async function syncEmployeePermissions(forceRender=false){
        if(!window.LDMEmployeePermissions||typeof window.LDMEmployeePermissions.context!=="function")return null;
        try{
            const context=await window.LDMEmployeePermissions.context(false,window.LDM_CLOUD_CONTEXT||null);
    ...
    window.addEventListener("ldm-employee-permissions-ready",()=>render());
    window.addEventListener("ldm-job-roles-updated",()=>{window.LDMEmployeePermissions?.clearCache?.();syncEmployeePermissions(true);});
    window.addEventListener("ldm-job-role-assignment-updated",()=>{window.LDMEmployeePermissions?.clearCache?.();syncEmployeePermissions(true);});
