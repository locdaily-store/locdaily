(function(){
    ...
    const PAGE_FEATURE={
        ...
        "recovery-center.html":"recovery_center","pwa-settings.html":"app_update","multi-store.html":"multi_store","cloud-control-center.html":"cloud_control","owner-control-center.html":"central_control","jabatan-hak-akses.html":"central_control",
    ...
    function esc(value){
        if(window.LDMSecurity?.escapeHTML)return window.LDMSecurity.escapeHTML(value);
